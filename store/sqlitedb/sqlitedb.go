...
func NewAppStateDB(dir string, table string) (*SQLiteDB, error) {
...
// Has interface
func (asdb *SQLiteDB) Has(height int64, table string, key []byte) (bool, error) {
...
func (asdb *SQLiteDB) HasMutable(height int64, table string, key []byte) (bool, error) {
...
// Get interface
//func (asdb *SQLiteDB) Get(height int64, table string, key []byte) ([]byte, error) {
...
func (asdb *SQLiteDB) GetMutableStmt(height int64, table string, key []byte) string {
	hexKey := strings.ToUpper(hex.EncodeToString(key))
	return strings.ReplaceAll(fmt.Sprintf(GetQuery, height, table, hexKey, height), "\n", " ")
}

func (asdb *SQLiteDB) GetMutable(height int64, table string, key []byte) ([]byte, error) {
...
// Set interface
//func (asdb *SQLiteDB) Set(height int64, table string, key []byte, value []byte) error {
...
func (asdb *SQLiteDB) SetMutableStmt(height int64, table string, key, value []byte) string {
	hexKey := strings.ToUpper(hex.EncodeToString(key))
...
func (asdb *SQLiteDB) SetMutable(height int64, table string, key, value []byte) error {
...
// Delete interface
//func (asdb *SQLiteDB) Delete(height int64, table string, key []byte) error {
...
func (asdb *SQLiteDB) DeleteMutableStmt(height int64, table string, key []byte) string {
	hexKey := strings.ToUpper(hex.EncodeToString(key))
	return strings.ReplaceAll(fmt.Sprintf(DeleteStatement, table, height, height, height, table, hexKey, height), "\n", " ")
}

func (asdb *SQLiteDB) DeleteMutable(height int64, table string, key []byte) error {
...
func (asdb *SQLiteDB) iteratorMutableSortedStmt(height int64, table string, start, end []byte, order iteratorOrder) string {
...
func (asdb *SQLiteDB) iteratorMutableSorted(height int64, table string, start, end []byte, order iteratorOrder) (dbm.Iterator, error) {
...
//func (asdb *SQLiteDB) iteratorSorted(height int64, table string, start, end []byte, order iteratorOrder) (dbm.Iterator, error) {
...
//func (asdb *SQLiteDB) Iterator(height int64, table string, start, end []byte) (dbm.Iterator, error) {
//	return asdb.iteratorSorted(height, table, start, end, Ascending)
//}

func (asdb *SQLiteDB) IteratorMutableStmt(height int64, table string, start, end []byte) string {
	return asdb.iteratorMutableSortedStmt(height, table, start, end, Ascending)
}

func (asdb *SQLiteDB) IteratorMutable(height int64, table string, start, end []byte) (dbm.Iterator, error) {
	return asdb.iteratorMutableSorted(height, table, start, end, Ascending)
}

//func (asdb *SQLiteDB) ReverseIterator(height int64, table string, start, end []byte) (dbm.Iterator, error) {
//	return asdb.iteratorSorted(height, table, start, end, Descending)
//}

func (asdb *SQLiteDB) ReverseIteratorMutableStmt(height int64, table string, start, end []byte) string {
	return asdb.iteratorMutableSortedStmt(height, table, start, end, Descending)
}

func (asdb *SQLiteDB) ReverseIteratorMutable(height int64, table string, start, end []byte) (dbm.Iterator, error) {
	return asdb.iteratorMutableSorted(height, table, start, end, Descending)
}

func (asdb *SQLiteDB) CommitMutable() error {
